function Footer({ onNavigate }) {
  const cols = [
    { head: 'The conference', links: [['Home', 'home'], ['About the conference', 'about'], ['How the day ran', 'program'], ['Speakers', 'speakers']] },
    { head: 'The record', links: [['The Policy Challenge', 'challenge'], ['Photo gallery', 'gallery']] },
  ];
  return (
      ...
      <div style={{
        ...
        {cols.map((c) => (
          <div key={c.head}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              ...
              {c.head === 'The record' ? (
                <span onClick={window.downloadCompendium} style={{ fontSize: 14, cursor: 'pointer', color: 'rgba(255,255,255,0.78)' }}>Download the compendium</span>
              ) : null}
            </div>
          </div>
        ))}
        <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 'var(--space-6)' }}>
            <a href="mailto:info@futurepathways.ng" style={{ fontSize: 14, color: 'rgba(255,255,255,0.78)' }}>info@futurepathways.ng</a>
            <a href="tel:+2349039547806" style={{ fontSize: 14, color: 'rgba(255,255,255,0.78)' }}>+234 903 954 7806</a>
            <a href="tel:+2349053455519" style={{ fontSize: 14, color: 'rgba(255,255,255,0.78)' }}>+234 905 345 5519</a>
          </div>
