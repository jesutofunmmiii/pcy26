...
`Speakers.jsx`, `Volunteer.jsx` and `Footer.jsx` are **not** included. The live Speakers page,
the live Volunteer page (form, copy and backend wiring) and the live Footer stay exactly as they are.
