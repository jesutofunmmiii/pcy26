function Program({ onNavigate }) {
  ...
  const deepDives = [
    ...
    { icon: 'flame', tag: 'Keynote', time: '30 mins', title: "Founder's session", lead: 'Dr Ayokunnu Ojeniyi', body: 'The founder speaks to the room as the person who began this work \u2014 why the convening exists, and what it asks of the people in it.' },
