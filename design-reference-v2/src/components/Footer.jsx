function Footer({ onNavigate }) {
  const cols = [
    { head: 'Conference', links: [['Home', 'home'], ['About the conference', 'about'], ['Full programme', 'program'], ['Watch it live', 'register']] },
    { head: 'Get involved', links: [['Volunteer with us', 'volunteer'], ['Register to stream', 'register'], ['The Policy Challenge', 'challenge']] },
  ];
  return (
