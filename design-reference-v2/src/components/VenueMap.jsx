function VenueMap() {
  ...
  const directions = [
    { icon: 'car', head: 'By car', body: 'Enter through UI’s First or Second Gate and follow the map link straight to the auditorium.' },
    { icon: 'bus', head: 'Campus shuttle', body: 'Board a shuttle at UI First Gate (main campus); it runs straight to the auditorium.' },
      ...
      <div className="section">
        <div className="mapsec-grid">
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <h2 style={{ margin: 'var(--space-3) 0 var(--space-4)', maxWidth: '14ch' }}>Find us at the KAAF Auditorium.</h2>
            <p style={{ color: 'var(--text-body)', margin: '0 0 var(--space-5)' }}>
              Department of Human Nutrition and Dietetics, University of Ibadan (UI), Ibadan, Oyo State.
            </p>
            <div style={{ margin: '0 0 var(--space-5)' }}>
              <div style={{ fontWeight: 600, color: 'var(--text-heading)', fontSize: 15, marginBottom: 8 }}>Nearby facilities &amp; landmarks</div>
              <ul style={{ margin: 0, paddingLeft: 20, color: 'var(--text-body)', fontSize: 14, lineHeight: 1.6, display: 'flex', flexDirection: 'column', gap: 6 }}>
                <li>A1 Kitchen — a popular food spot just behind the auditorium.</li>
                <li>Faculty of Economics — in the same academic zone.</li>
              </ul>
            </div>
            ...
            <div style={{ marginTop: 'var(--space-6)' }}>
              <a href="https://www.google.com/maps/search/?api=1&query=KAAF+Auditorium+University+of+Ibadan" target="_blank" rel="noopener noreferrer">
          ...
          <div style={{ borderRadius: 'var(--radius-lg)', overflow: 'hidden', border: '1px solid var(--border-default)', boxShadow: 'var(--shadow-card)', background: paper }}>
            <svg viewBox="0 0 880 600" width="100%" style={{ display: 'block' }} role="img" aria-label="Illustrated map of University of Ibadan showing the KAAF Auditorium">
