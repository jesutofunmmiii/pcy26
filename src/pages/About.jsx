      ...
      <section className="section reveal" style={{ padding: 'var(--space-9) var(--layout-margin)' }}>
        <div className="qa-stack" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--space-8)', alignItems: 'center' }}>
          ...
          <div style={{ height: 400, borderRadius: 'var(--radius-lg)', overflow: 'hidden', boxShadow: 'var(--shadow-raised)' }}>
            <img src="/gallery/about-minister.jpg" alt="The Honourable Minister of Industry, Trade and Investment greeting a delegate at the Policy Conference for Youth" style={{ display: 'block', width: '100%', height: '100%', objectFit: 'cover' }} />
          </div>
        </div>
      </section>
