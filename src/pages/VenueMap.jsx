...
export function VenueMap() {
  ...
  const directions = [
    ...
    },
    {
      icon: 'bus',
      head: 'Campus shuttle',
      body: 'Free delegate shuttles run from the Main Gate every 15 minutes on conference day.',
    },
    {
      icon: 'square-parking',
      head: 'Parking',
        ...
        <div className="mapsec-grid">
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <p style={{ color: 'var(--text-body)', margin: '0 0 var(--space-5)' }}>
              ...
              university, at the heart of the campus.
            </p>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)' }}>
              {directions.map((d) => (
                <div key={d.head} style={{ display: 'flex', gap: 14, alignItems: 'flex-start' }}>
                  ...
                  <div>
                    <div style={{ fontWeight: 600, color: 'var(--text-heading)', fontSize: 15 }}>
                      {d.head}
                    </div>
                    <div
                      style={{
            ...
            >
              ...
              <g>
                ...
                <g fill="#F5F1E4" stroke="#C9A22E" strokeWidth="1">
                  {[388, 410, 432, 454, 476, 498].map((cx) => (
                    <rect key={cx} x={cx} y="304" width="7" height="50" rx="1.5" />
                  ))}
                </g>
              ...
              <g>
                ...
                <g className="mapsec-pin">
                  <path
                    d="M440 196 C 421 196 407 210 407 228 C 407 250 440 276 440 276 C 440 276 473 250 473 228 C 473 210 459 196 440 196 Z"
                    fill="var(--gold-500)"
                    stroke="#8A6A00"
                    strokeWidth="2"
                  />
