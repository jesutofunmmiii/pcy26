    ...
    <footer style={{ background: '#04220C', color: 'rgba(255,255,255,0.72)' }}>
      <div
        ...
        style={{
          maxWidth: 'none',
          margin: 0,
          padding: 'var(--space-8) clamp(24px, 6vw, 120px) var(--space-6)',
          display: 'grid',
      ...
      >
        <div>
          <img
            ...
            style={{ height: 96, width: 'auto', display: 'block', marginBottom: 'var(--space-4)' }}
          />
          <p style={{ fontSize: 14, maxWidth: '34ch', color: 'rgba(255,255,255,0.7)', margin: 0 }}>
            An independent, pan-African organization strengthening governance through
            citizen-centred policy and youth leadership.
          </p>
        </div>
        {cols.map((c) => (
          <div key={c.head}>
      ...
      <div style={{ borderTop: '1px solid rgba(255,255,255,0.12)' }}>
        <div
          style={{
            maxWidth: 'none',
            margin: 0,
            padding: 'var(--space-4) clamp(24px, 6vw, 120px)',
            display: 'flex',
