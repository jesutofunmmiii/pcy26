function Program({ onNavigate }) {
  ...
  const schedule = [
    ...
    { time: '12:20', end: '12:50', type: 'Workshops', title: 'Breakout sessions (5 simultaneous)', lead: 'Room facilitators', purpose: 'Five concurrent thematic sessions where attendees deep-dive on specific reform tracks. Each room produces a one-pager for the communiqué.' },
  ...
  const deepDives = [
    ...
    { icon: 'layout-grid', tag: 'Workshops', time: '30 mins', title: 'Breakout sessions', body: 'Five simultaneous small-group sessions, each anchored to a reform track. Groups are facilitated, not lectured — every room produces a concrete one-pager fed into the communiqué.', points: ['Judicial reform & rule of law', 'Electoral integrity & democratic accountability', 'Public finance, anti-corruption & revenue transparency', 'Federalism, devolution & local governance', 'Civic engagement, youth & the new social contract'] },
      ...
      <section style={{ position: 'relative', overflow: 'hidden', background: 'var(--green-900)' }}>
        ...
        <div style={{ position: 'relative', padding: 'var(--space-9) clamp(24px, 6vw, 120px) var(--space-8)' }}>
          ...
          <p className="rise rise-3" style={{ color: 'rgba(255,255,255,0.82)', fontSize: 'var(--text-lg)', maxWidth: '62ch' }}>
            The day combines plenary engagements — a ministerial keynote, a structured panel and a Founder's address — with five breakout rooms, five Open House talks, and the Policy Challenge finals. Deliberately paced to sustain energy and reward participation.
          </p>
        </div>
      </section>
