        ...
        <div className="mapsec-grid">
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ marginBottom: 'var(--space-5)' }}>
              <div style={{ fontWeight: 600, color: 'var(--text-heading)', fontSize: 15, marginBottom: 'var(--space-2)' }}>Nearby facilities &amp; landmarks</div>
              <ul style={{ margin: 0, paddingLeft: '1.2em', color: 'var(--text-body)', fontSize: 14, lineHeight: 1.55, display: 'flex', flexDirection: 'column', gap: 4 }}>
          ...
          <div style={{ borderRadius: 'var(--radius-lg)', overflow: 'hidden', border: '1px solid var(--border-default)', boxShadow: 'var(--shadow-card)', background: paper }}>
            <svg viewBox="0 0 880 600" width="100%" style={{ display: 'block' }} role="img" aria-label="Illustrated map of the University of Ibadan showing the KAAF Auditorium">
